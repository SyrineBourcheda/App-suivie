      ...
      body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            if (!snapshot.hasData) {
              ...
              final List<Comment> comments = snapshot.data!.docs.map((doc) {
              ...
              if (_searchText.isNotEmpty) {
                filtredComments = comments.where((comment) {
                  final name = comment.Name.toLowerCase();
                  final searchText = _searchText.toLowerCase();
                  return name.contains(searchText);
                }).toList();
              } else {
                filtredComments = comments;
              }
              ...
              /* final List<Map<String, dynamic>> userList = users
                  .map((child) => {
                        ...
                        "email": child.email,
                        "paymentSatus": child.paymentStatus,
